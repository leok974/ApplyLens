...
def fetch_bigquery_table(bq_client: bigquery.Client, query: str) -> List[Dict[str, Any]]:
...
def export_risk_daily(bq_client: bigquery.Client, es_client: Elasticsearch) -> Dict[str, int]:
...
def export_parity_drift(bq_client: bigquery.Client, es_client: Elasticsearch) -> Dict[str, int]:
...
def export_backfill_slo(bq_client: bigquery.Client, es_client: Elasticsearch) -> Dict[str, int]:
...
def main():
    ...
    logger.info(f"Starting export from BigQuery to Elasticsearch")
