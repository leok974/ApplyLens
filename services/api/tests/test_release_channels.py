...
class TestEnvConfig:
    ...
    def test_canary_environment_defaults(self):
        ...
        with patch.dict(
            os.environ,
            {"APPLYLENS_ENV": "canary", "APPLYLENS_CANARY_PERCENTAGE": "25"},
            clear=True,
        ):
            config = get_env_config()
    ...
    def test_is_canary(self):
        ...
        with patch.dict(
            os.environ,
            {"APPLYLENS_ENV": "prod", "APPLYLENS_CANARY_PERCENTAGE": "50"},
            clear=True,
        ):
    ...
    def test_get_canary_percentage(self):
        ...
        with patch.dict(
            os.environ,
            {"APPLYLENS_ENV": "canary", "APPLYLENS_CANARY_PERCENTAGE": "15"},
            clear=True,
        ):
            init_config()
...
class TestReleasePromotion:
    ...
    def test_canary_promotion_workflow(self, mock_subprocess):
        ...
        with patch.dict(
            os.environ,
            {"APPLYLENS_ENV": "canary", "APPLYLENS_CANARY_PERCENTAGE": "10"},
            clear=True,
        ):
            config = get_env_config()
