...
class TestHeuristicTrainer:
    ...
    def test_train_for_agent_insufficient_data(self, mock_db):
        ...
        mock_db.query.return_value.filter_by.return_value.all.return_value = mock_examples
    ...
    def test_train_for_agent_logistic(self, mock_db, sample_examples):
        ...
        mock_db.query.return_value.filter_by.return_value.all.return_value = sample_examples
        
        bundle = trainer.train_for_agent("inbox_triage", min_examples=50, model_type="logistic")
    ...
    def test_train_for_agent_tree(self, mock_db, sample_examples):
        ...
        bundle = trainer.train_for_agent("inbox_triage", min_examples=50, model_type="tree")
    ...
    def test_generate_diff_update(self, mock_db):
        ...
        risk_change = next(c for c in diff["changes"] if c["param"] == "risk_score_threshold")
