    ...
    return {
        ...
        "payload": {
            "headers": [
                {
                    "name": "Subject",
                    "value": "Your statement is ready — amount due by 10/15/2025",
                },
            ...
            "body": {
                "data": enc(
                    "Amount due by 10/15/2025. Pay online at power.example.com. Total: $125.50"
                )
            },
        },
    }
...
def test_extract_due_dates_from_bill():
    ...
    received_dt = dt.datetime.utcfromtimestamp(recv_timestamp).replace(
        ...
        "payload": {
            ...
            "parts": [
                ...
                },
                {
                    ...
                    "body": {
                        "data": enc(
                            "<html><body>Payment due by Oct 20, 2025</body></html>"
                        )
                    },
                },
            ],
...
def test_bill_without_year_defaults_to_received_year():
    ...
    msg = {
        ...
        "payload": {
            ...
            "body": {"data": enc("Payment due by 10/15. Thank you.")},
        },
    }
...
def test_no_dates_returns_empty_arrays():
    ...
    msg = {
        ...
        "payload": {
            ...
            "body": {"data": enc("Thank you for signing up! No due dates here.")},
        },
    }
...
def test_combined_subject_and_body_extraction():
    ...
    msg = {
        ...
        "payload": {
            ...
            "body": {
                "data": enc(
                    "Your statement shows payment due by October 15, 2025. Please pay promptly."
                )
            },
        },
    }
