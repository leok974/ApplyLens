...
@pytest.mark.asyncio
async def test_create_reminders_emits_audit(monkeypatch):
    """
    ...
    async with AsyncClient(app=app, base_url="http://test") as ac:
        ...
        r = await ac.post("/productivity/reminders/create", json=payload)
...
@pytest.mark.asyncio
async def test_create_multiple_reminders(monkeypatch):
    """
...
@pytest.mark.asyncio
async def test_create_reminders_empty_list():
    """
...
@pytest.mark.asyncio
async def test_create_calendar_events(monkeypatch):
    """
    ...
    async with AsyncClient(app=app, base_url="http://test") as ac:
        ...
        r = await ac.post("/productivity/calendar/create", json=payload)
...
@pytest.mark.asyncio
async def test_nl_bills_creates_reminder(monkeypatch):
    """
...
@pytest.mark.asyncio
async def test_reminder_with_optional_fields(monkeypatch):
    """
...
@pytest.mark.asyncio
async def test_calendar_event_empty_list():
    """
...
async def test_list_reminders_empty(monkeypatch):
    ...
    async with AsyncClient(app=app, base_url="http://test") as ac:
        r = await ac.get("/productivity/reminders/list")
...
@pytest.mark.asyncio
async def test_list_reminders_with_data(monkeypatch):
    """
    ...
    async with AsyncClient(app=app, base_url="http://test") as ac:
        r = await ac.get("/productivity/reminders/list?limit=10")
...
@pytest.mark.asyncio
async def test_reminder_with_custom_source(monkeypatch):
    """
