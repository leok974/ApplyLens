...
class TestPlannerSwitchboard:
    ...
    def test_shadow_execution_both_planners_run(self):
        ...
        with patch.object(switchboard.v1, 'plan') as mock_v1, \
    ...
    def test_diff_computation_steps_changed(self):
        ...
        with patch.object(switchboard.v1, 'plan') as mock_v1, \
             patch.object(switchboard.v2, 'plan') as mock_v2:
            mock_v1.return_value = {"agent": "inbox", "steps": ["validate", "prepare_tools", "act", "summarize"]}
            mock_v2.return_value = {"agent": "inbox", "steps": ["prepare", "execute", "summarize"]}
    ...
    def test_diff_computation_no_changes(self):
        ...
        with patch.object(switchboard.v1, 'plan') as mock_v1, \
            ...
            mock_v2.return_value = {"agent": "inbox", "steps": ["a", "b"], "required_capabilities": []}
