...
class TestOnCallManager:
    ...
    def test_acknowledge_incident(self, manager):
        ...
        success = manager.acknowledge_incident(
            incident.incident_id, "oncall@example.com"
        )
    ...
    def test_get_incident_metrics(self, manager):
        ...
        manager.create_incident("Inc 3", "Test", IncidentSeverity.SEV1)
...
class TestPagerDutyIntegration:
    ...
    async def test_alert_slo_violation(self):
        ...
        with patch.object(
            integration.client, "trigger_incident", new_callable=AsyncMock
        ) as mock_trigger:
