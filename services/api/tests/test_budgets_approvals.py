...
def test_approvals_check_budget_time_not_exceeded():
    ...
    result = Approvals.check_budget(
        elapsed_ms=500, ops_count=10, budget_ms=1000, budget_ops=20
    )
...
def test_approvals_check_budget_time_exceeded():
    ...
    result = Approvals.check_budget(
        elapsed_ms=1500, ops_count=10, budget_ms=1000, budget_ops=20
    )
...
def test_approvals_check_budget_ops_exceeded():
    ...
    result = Approvals.check_budget(
        elapsed_ms=500, ops_count=25, budget_ms=1000, budget_ops=20
    )
...
def test_approvals_check_budget_no_limits():
    ...
    result = Approvals.check_budget(
        elapsed_ms=5000, ops_count=100, budget_ms=None, budget_ops=None
    )
...
def test_executor_budget_ops_limit():
    ...
    run = executor.execute(plan, handler_with_ops, budget_ops=20, allow_actions=False)
