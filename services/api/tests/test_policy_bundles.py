...
class TestPolicyBundleCRUD:
    ...
    async def test_create_bundle_invalid_version_format(
        self,
        client: AsyncClient
    ):
    ...
    async def test_create_bundle_invalid_rule_schema(
        self,
        client: AsyncClient
    ):
    ...
    async def test_create_bundle_duplicate_rule_ids(
        self,
        client: AsyncClient
    ):
