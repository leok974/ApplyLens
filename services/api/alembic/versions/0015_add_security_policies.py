...
def upgrade():
    op.create_table(
        ...
        sa.Column("auto_quarantine_high_risk", sa.Boolean, nullable=False, server_default=sa.text("true")),
        sa.Column("auto_archive_expired_promos", sa.Boolean, nullable=False, server_default=sa.text("true")),
        sa.Column("auto_unsubscribe_enabled", sa.Boolean, nullable=False, server_default=sa.text("false")),
        sa.Column("auto_unsubscribe_threshold", sa.Integer, nullable=False, server_default="10"),
