...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_approvals_proposed_email_id", "approvals_proposed", ["email_id"]
    )
    op.create_index(
        "ix_approvals_proposed_created_at", "approvals_proposed", ["created_at"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_approvals_proposed_status_policy", table_name="approvals_proposed"
    )
