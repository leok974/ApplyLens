...
crypto_encrypt_total = Counter(
    ...
    'Total number of tokens encrypted'
)

crypto_decrypt_total = Counter(
    'applylens_crypto_decrypt_total',
    'Total number of tokens decrypted successfully'
)
...
session_destroyed_total = Counter(
    'applylens_session_destroyed_total',
    'Total number of sessions destroyed (logout)'
)
