...
class PolicyEngine:
    ...
    def evaluate_condition(
        self, condition: Dict[str, Any], email: Dict[str, Any]
    ) -> bool:
        """
        ...
        if field in ["received_at", "expires_at", "created_at"] and isinstance(
            actual_value, str
        ):
            try:
    ...
    def evaluate_conditions(
        self, conditions: Dict[str, Any], email: Dict[str, Any]
    ) -> bool:
        """
        ...
        if "all" in conditions:
            ...
            return all(
                (
                    self.evaluate_condition(cond, email)
                    if "field" in cond
    ...
    def evaluate_policy(
        self, policy: Dict[str, Any], email: Dict[str, Any]
...
DEFAULT_POLICIES = [
    {
        ...
        "then": {"action": "archive", "confidence_min": 0.7, "notify": False},
    },
    {
        "id": "risk-quarantine",
        "description": "Quarantine high-risk emails for review",
        "if": {"any": [{"field": "risk_score", "op": ">=", "value": 80}]},
    ...
    },
    {
        ...
        "if": {"all": [{"field": "category", "op": "=", "value": "applications"}]},
        "then": {
            "action": "label",
        ...
        "if": {
            "all": [
                {"field": "category", "op": "=", "value": "promotions"},
                {
                    ...
                    "op": "<",
                    "value": "30_days_ago",
                },  # Note: Need to handle this special value
            ]
        },
        "then": {"action": "delete", "confidence_min": 0.9, "notify": False},
    },
]
