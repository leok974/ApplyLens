...
def create_audit_index():
    ...
    try:
        ...
        print(f"   - email_id (keyword)")
        print(f"   - action (keyword)")
        print(f"   - actor (keyword) - agent|user|system")
        print(f"   - policy_id (keyword)")
        print(f"   - confidence (float)")
        print(f"   - rationale (text)")
        print(f"   - status (keyword) - proposed|approved|rejected|executed")
        print(f"   - created_at (date)")
        print(f"   - payload (flattened)")
