    ...
    def _update_daily_metrics(self, result: EvalResult) -> None:
        ...
        if metrics.quality_samples == 0:
            ...
            metrics.avg_quality_score = (
                metrics.avg_quality_score * n + result.quality_score
            ) / (n + 1)
        ...
        if metrics.total_runs == 0:
            ...
            metrics.avg_latency_ms = (
                metrics.avg_latency_ms * n + result.latency_ms
            ) / (n + 1)
...
class MetricsAggregator:
    ...
    def get_agent_metrics(
        ...
        return (
            ...
            .order_by(AgentMetricsDaily.date)
            .all()
        )
    ...
    def get_weekly_summary(
        ...
        avg_quality = (
            sum(quality_scores) / quality_samples if quality_samples > 0 else 0.0
        )
    ...
    def detect_regression(
        ...
        quality_drop = (
            prev_summary["avg_quality_score"] - current_summary["avg_quality_score"]
        )
