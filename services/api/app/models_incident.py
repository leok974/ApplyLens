...
from sqlalchemy import Integer, String, DateTime, JSON, Text, Index, func
...
class Incident(Base):
    ...
    )  # invariant|budget|planner|bundle|gate
    key: Mapped[str] = mapped_column(
        String(128), nullable=False
    )  # e.g., INV_PHISHING_LABEL
    ...
    playbooks: Mapped[list] = mapped_column(
        JSON, default=list
