...
class KnowledgeUpdaterAgent:
    ...
    def plan(self, objective: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config_type = params.get('config_type', 'synonyms')  # synonyms, routing_rules, etc.
    ...
    def _generate_report(
        ...
        if not applied and not dry_run:
            report.append("## Note\n")
            report.append("Changes were not applied. Approval may be required for large updates.\n")
