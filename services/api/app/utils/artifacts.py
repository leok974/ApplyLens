...
class ArtifactsStore:
    ...
    def write(self, path: str, content: str, agent_name: Optional[str] = None) -> str:
        """
    ...
    def list_files(
        self, agent_name: Optional[str] = None, pattern: str = "*"
    ) -> List[str]:
        """
    ...
    def get_timestamped_path(
        self, prefix: str, extension: str = "json", agent_name: Optional[str] = None
    ) -> str:
        """
    ...
    def get_weekly_path(self, prefix: str = "", extension: str = "md") -> str:
        """
