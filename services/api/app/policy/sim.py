...
def simulate_rules(
    rules: list[dict[str, Any]], cases: list[SimCase], seed: int = 1337
) -> SimResponse:
    """
...
def _generate_examples(
    cases: list[SimCase], results: list[SimResult]
) -> list[dict[str, Any]]:
...
def generate_fixtures() -> list[SimCase]:
    ...
    return [
        ...
        SimCase(
            ...
            action="deploy",
            context={"version": "v1.2.3", "canary_pct": 10, "risk_level": "medium"},
        ),
        SimCase(
        ...
        SimCase(
            ...
            agent="inbox.triage",
            action="quarantine",
            context={"risk_score": 100, "confidence": 1.0, "domain_seen_days": 0},
        ),
    ]
        ...
        if agent == "inbox.triage":
            context = {
                ...
                "category": random.choice(
                    ["spam", "phishing", "newsletter", "transactional"]
                ),
            }
