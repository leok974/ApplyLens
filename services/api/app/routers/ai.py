...
class SummarizeRequest(BaseModel):
    ...
    max_citations: int = Field(default=3, ge=0, le=5, description="Maximum citations to return")
...
async def summarize_thread(request: SummarizeRequest):
    ...
    # Build prompt
    system_prompt = "You are a precise email summarizer for hiring panels. Be concise and factual."
