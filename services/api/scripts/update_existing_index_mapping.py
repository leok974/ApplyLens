...
SECURITY_FIELDS_MAPPING = {
    "properties": {
        ...
        "url_hosts": {"type": "keyword"},
        "domain_tld": {"type": "keyword"},
        "domain_first_seen_at": {"type": "date"},
        "domain_first_seen_days_ago": {"type": "integer"},
...
def update_index_mapping(es_url: str, index_name: str) -> bool:
    ...
    try:
        ...
        es.indices.put_mapping(index=index_name, body=SECURITY_FIELDS_MAPPING)
