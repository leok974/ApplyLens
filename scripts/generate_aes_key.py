...
if __name__ == "__main__":
    ...
    print()
    print("   # GCP")
    print(f"   echo '{key}' | gcloud secrets versions add APPLYLENS_AES_KEY_BASE64 --data-file=-")
    print()
    print("   # AWS")
    print(f"   aws secretsmanager create-secret --name APPLYLENS_AES_KEY_BASE64 --secret-string '{key}'")
    print()
