...
r = requests.get(
    ...
    params={"q": "interview", "replied": "true", "sort": "ttr_asc", "size": "3"},
)
...
r = requests.get(
    "http://localhost:8003/search",
    params={"q": "interview", "sort": "ttr_desc", "size": "3"},
)
...
r = requests.get(
    "http://localhost:8003/search",
    params={"q": "offer", "sort": "received_desc", "size": "3"},
)
...
r = requests.get(
    "http://localhost:8003/search",
    params={"q": "application", "sort": "received_asc", "size": "3"},
)
...
r = requests.get(
    "http://localhost:8003/search",
    params={"q": "interview", "sort": "relevance", "size": "3"},
)
